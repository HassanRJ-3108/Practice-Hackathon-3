...
import { addToCart, removeFromWishlist, getWishlistItems, moveAllToCart } from "@/app/actions/actions"
...
export default function WishlistPage() {
    ...
    const ProductCard = ({ item, isWishlistItem = false }: { item: Product, isWishlistItem?: boolean }) => (
        <div className="group">
